    ...
    <>
      {show !== "test" && (
        <div id="background_lobby">
          ...
          {!show && (
            <>
              <button onClick={disconnect} style={{ position: "absolute", zIndex: "1" }}>
                Disconnect
              </button>
              ...
              <Table>
                <div
                  ...
                  title="Create a game"
                  onMouseOver={() => {
                    set_item_behind_mouse("create_game");
                  }}
                  onMouseLeave={() => {
                    set_item_behind_mouse(null);
                  }}
                ...
                <div
                  ...
                  title="Join a game"
                  onMouseOver={() => {
                    set_item_behind_mouse("join_game");
                  }}
                  onMouseLeave={() => {
                    set_item_behind_mouse(null);
                  }}
                ...
                <div
                  ...
                  onMouseOver={() => {
                    set_item_behind_mouse("parameters");
                  }}
                  onMouseLeave={() => {
                    set_item_behind_mouse(null);
                  }}
                ...
                <div
                  ...
                  onMouseOver={() => {
                    set_item_behind_mouse("statistics");
                  }}
                  onMouseLeave={() => {
                    set_item_behind_mouse(null);
                  }}
